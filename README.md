...
<body>
  ...
  <script>
    const wordData = {
      1: [
        { english: "tangible", chinese: "可触摸的；可触知的；有形的；确凿的；明显的；实在的" },
        { english: "intangible", chinese: "触摸不到的；难以捉摸的；不易形容的；（企业资产）无形的" },
        { english: "fabulous", chinese: "极好的；绝妙的；巨额的；巨大的" },
        { english: "hurdle", chinese: "障碍；困难；栏架；（跑步过程中）跨越" },
        { english: "evoke", chinese: "引起，唤起（强烈的感情或回忆）" },
        { english: "streamline", chinese: "（企业、组织等）精简（使效率更高）；使…成为流线型" },
        { english: "mode", chinese: "方式；方法；做法；（机器、设备的）运行方式，状态，模式" },
        { english: "inhabitant", chinese: "居民" },
        { english: "equate", chinese: "使等同" },
        { english: "inclusive", chinese: "包容广阔的；范围广的；（价钱或费用）包括一切的" },
        { english: "poised", chinese: "准备好的；准备就绪的；镇定的；自信的；沉着的" },
        { english: "transit", chinese: "交通运输系统；（货物或人的）运输" },
        { english: "lavish", chinese: "大量的；昂贵的；使人印象深刻的；慷慨的；大方的；慷慨给予" },
        { english: "cellular", chinese: "蜂窝式的；由细胞组成的；细胞的" },
        { english: "computing", chinese: "计算机使用；计算机技能；计算机编程" },
        { english: "parameter", chinese: "参数；界限；范围" },
        { english: "constitute", chinese: "形成；构成；组成；被视为；被算作" },
        { english: "concrete", chinese: "混凝土；混凝土的；具体的" },
        { english: "sensor", chinese: "传感器，感应装置" },
        { english: "minimal", chinese: "极小的；极少的；（尤指）最小的，最少的" },
        { english: "hypothesis", chinese: "假设；假说" },
        { english: "alert", chinese: "使警觉；向…发出警报；警惕的；警觉的；机警的；机敏的" },
        { english: "instantaneous", chinese: "即刻的；即时的" },
        { english: "instantaneously", chinese: "即刻地；即时地" },
        { english: "dispatch", chinese: "（正式）派遣；发送；派遣；发送；公文，信件" },
        { english: "urbanization", chinese: "城市化" },
        { english: "modernize", chinese: "使（系统、建筑物等）现代化；采用现代方法和设备；现代化" },
        { english: "benchmark", chinese: "基准；规范" },
        { english: "demographic", chinese: "人口的；人口统计的；人口学的；人口统计数据；人口统计资料" },
        { english: "infrastructure", chinese: "基础设施；基础结构" },
        { english: "infrastructural", chinese: "基础设施的；基础结构的" },
        { english: "predominant", chinese: "占优势的；占主导地位的；显著的" },
        { english: "predominantly", chinese: "绝大多数地；主要地" },
        { english: "fossil", chinese: "化石" },
        { english: "fossil fuel", chinese: "化石燃料（如煤、石油等）" },
        { english: "devastating", chinese: "毁灭性的；破坏力极强的；令人十分震惊的；具有强大冲击力的" },
        { english: "excess", chinese: "过多的；多余的；过多；过量" },
        { english: "prone", chinese: "易于发生某事（尤指不好或有害的事）的；很可能…的" },
        { english: "detrimental", chinese: "有害的；不利的" },
        { english: "outdated", chinese: "过时的；陈旧的" },
        { english: "escalate", chinese: "（使）升级；（使）恶化" },
        { english: "jargon", chinese: "术语；行话" },
        { english: "interlink", chinese: "（使）相互连接" },
        { english: "intuitive", chinese: "直觉的；来自直觉的；有直觉力的" },
        { english: "optimal", chinese: "最佳的；最适宜的" },
        { english: "optimize", chinese: "使最优化；使尽可能完善" },
        { english: "be projected to do sth.", chinese: "预计要" },
        { english: "define sth. as", chinese: "把…定义为；把…描述为" },
        { english: "equate sth. to /with sth.", chinese: "认为某物与另一物相等或相仿" },
        { english: "integrate (sth.) with /into sth.", chinese: "将某事物与另一事物结合成为一体" },
        { english: "be poised to do sth.", chinese: "准备好做某事；准备行动" },
        { english: "on top of sth.", chinese: "除…之外" },
        { english: "within /at a moment’s notice", chinese: "立刻；马上" },
        { english: "within (one’s) grasp", chinese: "在（某人）掌握之中的；触手可及的" },
        { english: "rid sth. /sb. of sth.", chinese: "使摆脱掉；使除掉" },
        { english: "to that end", chinese: "为此；为达此目标" },
        { english: "be modeled on", chinese: "效仿；仿制" },
